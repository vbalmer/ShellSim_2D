...
class stress():
        ...
        def sc_fib(e):
            ...
            if e < 0:
                ...
                if abs(e) < ec0:
                    ...
                    sc3 = 0 - fc + (e + ec0) / 1000
            elif e < self.fct/self.Ec: # e < self.ect:
                sc3 = self.Ec * e
            else:
                sc3 = ff * e
            return sc3
    ...
    def sr0_vc(self):
        ...
        if self.rhox + self.rhopx > 0:
            if self.dpx == 0: 
                self.srx0 = (2*self.tb0/self.dx*self.rhox)**(-1)*self.fct*(1-self.rhox)
            else:
        ...
        if self.rhoy + self.rhopy > 0:
            if self.dpy == 0:
                self.sry0 = (2 * self.tb0 / self.dy * self.rhoy) ** (-1) * self.fct * (1 - self.rhoy)
            else:
                self.sry0 = (2 * self.tb0 / self.dy * self.rhoy + 2 * self.tbp0 / self.dpy * self.rhopy) ** (-1) * self.fct * (1 - self.rhoy - self.rhopy)
        else:
            self.sry0 = 10**6
    ...
    def sigma_cart_1(self):
        ...
        # self.sr0_vc()  # removed this line of code, as it produced errors. And it is not required for the lin.el. law to calculate these properties.
        self.sx_xy = 0
        self.sy_xy = 0
        self.txy_x = 0
        self.txy_y = 0
    ...
    def out(self,e):
        ...
        self.principal()
        if self.cm_klij == 1 or self.cm_klij == 10:
            self.submodel = 0
            self.iscracked = 0
            self.sigma_cart_1()
        elif self.cm_klij == 3:
