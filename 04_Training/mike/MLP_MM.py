...
De = np.load(os.path.join(os.getcwd(),"data\\data_20241022_1853_case4\\newadd_data_De.pkl"), allow_pickle=True)
eps = np.load(os.path.join(os.getcwd(), "data\\data_20241022_1853_case4\\newadd_data_eps.pkl"), allow_pickle=True)
sig = np.load(os.path.join(os.getcwd(), "data\\data_20241022_1853_case4\\newadd_data_sig.pkl"), allow_pickle=True)
t = np.load(os.path.join(os.getcwd(), "data\\data_20241022_1853_case4\\newadd_data_t.pkl"), allow_pickle=True)
