...
# load_levels = [200, 400, 600, 800, 900, 920, 940, 950, 960, 970, 980]
# load_levels = [200, 400, 600, 800, 820, 840, 850, 860, 870]
# load_levels = [100, 200, 300, 400, 450, 500]
# load_levels = [50, 100]


# rho_y = 1.5%
# load_levels = [200, 600, 1000, 1200, 1400, 1600, 1650, 1700, 1710, 1720, 1730]
# load_levels = [200, 400, 600, 800, 1000, 1100, 1200, 1300, 1350, 1375, 1390]
# load_levels = [200, 600, 800, 1000, 1100, 1150, 1175]
# load_levels = [200, 400, 600, 800, 1000, 1100, 1200, 1300, 1350, 1375, 1400, 1410, 1420]
# load_levels = [200, 600, 1000, 1200, 1400, 1600, 1800, 2000, 2025, 2050, 2060, 2070]
# load_levels = [-2000, -4000, -6000, -8000, -9000, -10000, -10100, -10200, -10250, -10300]
# load_levels = [-2000, -4000, -6000, -8000, -10000, -10250, -10250, -10500, -10750, -11000]
# load_levels = [-200, -500, -1000, -2000, -2050, -2100, -2150, -2200]
# load_levels = [200, 400, 600, 800, 900, 920, 940, 950, 960, 970, 980, 1000, 1050]
# load_levels = [-200, -1000, -2000, -3000, -3500, -4000, -4250, -4500]
# load_levels = [100, 200, 300, 400, 500, 525, 550, 575, 600]

# rho_y = 0.75%
# load_levels = [200, 400, 600, 800, 1000, 1100, 1125, 1150, 1175, 1200]
# load_levels = [200, 400, 600, 800, 1000, 1050]
# load_levels = [200, 400, 600, 625, 650, 675, 700, 725, 750]
# load_levels = [200, 400, 600, 800, 1000, 1100, 1200, 1300, 1350, 1375, 1400, 1410, 1420]
