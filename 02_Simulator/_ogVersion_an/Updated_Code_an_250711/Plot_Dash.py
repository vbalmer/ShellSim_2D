...
indicators3 = ['ux','uy','uz','thx','thy','thz','Mx','My','Mxy','Nx','Ny','Nxy','Qx','Qy','ex','ey','gxy','e3','e1','thr','thc','cm','ssx','ssy',
...
def update_graph(aplot,splot,cplot,lplot,varplot):
    ...
    # 4.9.6 Colorplots
    if cplot == 'ex' or cplot == 'ey' or cplot == 'gxy' or cplot == 'e3' or cplot == 'e1' or cplot == 'thr' or cplot == 'thc' or cplot == 'cm' or cplot == 'ssx' or cplot == 'ssy' or cplot == 'spx' or cplot == 'spy' or cplot == 'relex' or cplot == 'reley' or cplot == 'relgxy':
