...
def post(ux,uy,uz,r,thx,thy,thz,Nx,Ny,Nxy,Mx,My,Mxy,Qx,Qy,ex,ey,gxy,e3,e1,thr,thc,cm,ssx,ssy,spx,spy,rele,relun,relthn):
    ...
    for ia in range(na):
        ...
        layer = nl_a[ia] - 1 # -1 für obersten
