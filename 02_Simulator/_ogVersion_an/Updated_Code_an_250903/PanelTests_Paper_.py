import numpy as np
from Stresses_mixreinf import stress,lbd, do_itkin, do_char, ff_ev
...
""" ---------------------------------------------------------------------------------------------------------------- 
 ---------------------------------------------------- Initiate -----------------------------------------------------
 ------------------------------------------------------------------------------------------------------------------- """
path = r'C:\Users\naesboma\00_an\04_UHBB\06_Papers\06_Numerical_Modelling\02_Modell\02_Nachrechnungen_Paper_trial_and_error'
...
# Tests = ['PV10', 'PV19', 'PV20', 'PV21', 'PV22','PV27'] # Toronto, normal strength
...
# Tests = ['SL1','SL3','PT1'] # Zürich, show
# Tests = ['SE1','SE6','PP1','PT1','PP2','PP3','SL1','SL3']
# Tests = ['VA0','VA2','VA4','VB1','VB2','VB3','HB3','HB4']
# Tests = ['VB1','VB2','VB3','HB3','HB4']
# Tests = ['SL1']
# Tests = ['PP2','PP3']
Tests = ['VA0','VA1','VA2','VA3','VA4','PV10', 'PV19', 'PV20', 'PV21', 'PV22','PV27','PP1','PP2','PP3','SE1','SE6','HB3','HB4',
            'VB1','VB2','VB3','PHS2','PHS3','PHS4','PHS5','PHS6','PHS7','SL1','SL3','PT1','SL7','PV13']
# Tests = ['PHS2','PHS3','PHS4','PHS5','PHS6','PHS7','SL1','SL3','PT1','SL7','PV13']
# Tests = ['PT1','SE1','PP2','PV13','VA1','VB1','HB4','PHS5']
...
" ---------------------------------------------------- SL7 ------------------------------------------------------------"
fcp['SL7'] = 30.2
Ec['SL7'] = 10000*fcp['SL7']**(1/3)
Gc['SL7'] = Ec['SL7']/2
vc['SL7'] = 0
t['SL7'] = 350
fct['SL7'] = 0.3*fcp['SL7']**(2/3)/2
ec0['SL7'] = 2e-3
Dmax['SL7'] = 16
...
fsux['SL7'] = 631.9
Esx['SL7'] = 192700
esyx = fsyx['SL7']/Esx['SL7']
esux = 0.108
Eshx['SL7'] = (fsux['SL7']-fsyx['SL7'])/(esux-esyx)
dx['SL7'] = 14
sx['SL7'] = 100
rhox['SL7'] = 0.0088
...
fsuy['SL7'] = 624.6
Esy['SL7'] = 192100
esyy = fsyy['SL7']/Esy['SL7']
esuy = 0.0997
Eshy['SL7'] = (fsuy['SL7']-fsyy['SL7'])/(esuy-esyy)
dy['SL7'] = 8
sy['SL7'] = 200
rhoy['SL7'] = 0
...
tb0['SL7'] = 2*fct['SL7']
tb1['SL7'] = 1*fct['SL7']
tbp0['SL7'] = 2*fct['SL7']/100
tbp1['SL7'] = fct['SL7']/100
...
ebp1['PP2'] = 0.00455
sp0['PP2'] = 707
fpux['PP2'] = 910 - sp0['PP2']
fpuy['PP2'] = 910 - sp0['PP2']
dpx['PP2'] = 8
dpy['PP2'] = 8
rhopx['PP2'] = 0.00293
rhopy['PP2'] = 0
...
ebp1['PP3'] = 0.00455
sp0['PP3'] = 750
fpux['PP3'] = 910 - sp0['PP3']
fpuy['PP3'] = 910 - sp0['PP3']
dpx['PP3'] = 30
dpy['PP3'] = 30
rhopx['PP3'] = 0.00586
rhopy['PP3'] = 0
...
" ---------------------------------------------------- PV13 ------------------------------------------------------------"
fcp['PV13'] = 18.2
Ec['PV13'] = 10000*fcp['PV13']**(1/3)
Gc['PV13'] = Ec['PV13']/2
vc['PV13'] = 0
t['PV13'] = 70
fct['PV13'] = 0.3*fcp['PV13']**(2/3)
ec0['PV13'] = 2.7e-3
Dmax['PV13'] = 6
...
fsux['PV13'] = 248*1.2
Esx['PV13'] = 200000
esyx = fsyx['PV13']/Esx['PV13']
esux = 0.1
Eshx['PV13'] = (fsux['PV13']-fsyx['PV13'])/(esux-esyx)
dx['PV13'] = 6.35
sx['PV13'] = 50
rhox['PV13'] = 0.01785
...
fsuy['PV13'] = 317
Esy['PV13'] = 200000
esyy = fsyy['PV13']/Esy['PV13']
esuy = 0.1
Eshy['PV13'] = (fsuy['PV13']-fsyy['PV13'])/(esuy-esyy)
dy['PV13'] = 4.7
sy['PV13'] = 50
rhoy['PV13'] = 0
...
mult = 1.2
fcp['PHS1'] = 72.2
Ec['PHS1'] = 10000*fcp['PHS1']**(1/3)
Gc['PHS1'] = Ec['PHS1']/2
vc['PHS1'] = 0
t['PHS1'] = 70
fct['PHS1'] = 0.3*fcp['PHS1']**(2/3)/2
ec0['PHS1'] = 2.68e-3
Dmax['PHS1'] = 10
...
fsux['PHS1'] = 606*mult
Esx['PHS1'] = 200000
esyx = fsyx['PHS1']/Esx['PHS1']
esux = 0.1
Eshx['PHS1'] = (fsux['PHS1']-fsyx['PHS1'])/(esux-esyx)
dx['PHS1'] = 8
sx['PHS1'] = 45
rhox['PHS1'] = 0.0323
...
fsuy['PHS1'] = 521*mult
Esy['PHS1'] = 1
esyy = fsyy['PHS1']/Esy['PHS1']
esuy = 0.1
Eshy['PHS1'] = (fsuy['PHS1']-fsyy['PHS1'])/(esuy-esyy)
dy['PHS1'] = 5.72
sy['PHS1'] = 45
rhoy['PHS1'] = 0
...
tb0['PHS1'] = 2*fct['PHS1']
tb1['PHS1'] = fct['PHS1']
tbp0['PHS1'] = 2*fct['PHS1']/100
tbp1['PHS1'] = fct['PHS1']/100
...
# # 0 Testnames
# import csv
# with open('testnames.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in rhox.items():
#        writer.writerow([value[0]])
#
# # 1 rhox
# with open('rhox.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in rhox.items():
#        writer.writerow([round(value[1]*100,2)])
#
# # 1 dx
# with open('dx.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in dx.items():
#        writer.writerow([round(value[1],1)])
#
# # 1 Esx
# with open('Esx.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in Esx.items():
#        writer.writerow([round(value[1]/1000,0)])
#
# # 1 fsyx
# with open('fsyx.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in fsyx.items():
#        writer.writerow([round(value[1],0)])
#
# # 1 fsux
# with open('fsux.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in fsux.items():
#        writer.writerow([round(value[1],0)])
#
# # 1 rhox
# with open('rhoy.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in rhoy.items():
#        writer.writerow([round(value[1]*100,2)])
#
# # 1 dx
# with open('dy.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in dy.items():
#        writer.writerow([round(value[1],1)])
#
# # 1 Esy
# with open('Esy.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in Esy.items():
#        writer.writerow([round(value[1]/1000,0)])
#
# # 1 fsyy
# with open('fsyy.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in fsyy.items():
#        writer.writerow([round(value[1],0)])
#
# # 1 fsuy
# with open('fsuy.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in fsuy.items():
#        writer.writerow([round(value[1],0)])
#
# # 1 fcp
# with open('fcp.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in fcp.items():
#        writer.writerow([round(value[1],0)])
#
# # 1 ec0
# with open('ec0.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in ec0.items():
#        writer.writerow([round(value[1]*1000,2)])
#
# # 1 Dmax
# with open('Dmax.csv', 'w', newline='') as csv_file:
#     writer = csv.writer(csv_file)
#     for value in Dmax.items():
#        writer.writerow([round(value[1],1)])
...
for j in range(len(Tests)):
    ...
    MAT = [Ec[Tests[j]], vc[Tests[j]], fcp[Tests[j]], 0.5*fct[Tests[j]], ec0[Tests[j]], 0.5*fct[Tests[j]]/Ec[Tests[j]],
    ...
    GEOM = [rhox[Tests[j]], rhoy[Tests[j]], dx[Tests[j]], dy[Tests[j]], sx[Tests[j]], sy[Tests[j]], rhopx[Tests[j]],
            rhopy[Tests[j]], dpx[Tests[j]], dpy[Tests[j]],t[Tests[j]]]
    ...
    if Tests[j] == 'VA0':
        ...
        sx_model = np.linspace(0, 0, steps)
        sy_model = np.linspace(0, 0, steps)
    elif Tests[j] == 'PV10' or Tests[j] == 'PV13' or Tests[j] == 'PV19' or Tests[j] == 'PV20' or Tests[j] == 'PV21' or Tests[j] == 'PP1':
        ...
        if do_itkin:
            txy_model = np.linspace(.1, 5.465, steps)
        else:
            txy_model = np.linspace(.1, 7, steps)
        sx_model = np.linspace(0, 0, steps)
        sy_model = np.linspace(0, 0, steps)
        ...
        if do_itkin:
            txy_model = np.linspace(.1, 7.12, steps)
        else:
        ...
        txy_model = np.linspace(.01, 3, steps)
        sx_model = np.linspace(0, 0, steps)
        sy_model = np.linspace(0, 0, steps)
    elif Tests[j] == 'PHS2':
        txy_model = np.linspace(.1, 8, steps)
        ...
        sx_model = np.linspace(0, 0, steps)
        sy_model = np.linspace(0, 0, steps)
        # txy_model = np.linspace(-0.1, -5, steps)
        # sx_model = np.linspace(-6, 5, steps)
        # sy_model = np.linspace(0, 0, steps)
    elif Tests[j] == 'SL1':
        txy_model = np.linspace(.1, 1.25, steps)*(fcp['SL1']**(1/2)/3)
        sx_model = np.linspace(0, 0.13, steps)
        sy_model = np.linspace(0, 0.10, steps)
        txy_test = [i*(fcp['SL1']**(1/2)/3) for i in txy_test]
    elif Tests[j] == 'SL3':
        txy_model = np.linspace(.1, 1.25, steps)*(fcp['SL3']**(1/2)/3)
        sy_model = np.linspace(.125, .125, steps)
        ...
        sx_model = fsx(t_txy)
        sx_model = np.linspace(1, -.8, steps)
    elif Tests[j] == 'SL7':
        txy_model = np.linspace(.1, 1.7, steps)
        sx_model = np.linspace(0.1, 0.1, steps)
        sy_model = np.linspace(-.15, -.15, steps)
        txy_test = [i*(fcp['SL7']**(1/2)/3) for i in txy_test]


    ex_test = np.ones_like(gxy_test)/1000
    ey_test = np.zeros_like(gxy_test)/1000
    ex_test = [i+10**-8 for i in ex_test]
    ey_test = [i + 10 ** -8 for i in ey_test]
    ...
    tdtnr = np.zeros_like(ex_model)
    sdnr = np.zeros_like(ex_model)
    ...
    # 5 Initiate Sig_prev
    sig_prev = stress(0, 3, MAT, GEOM, cmcc_klij, cmcs_klij, cms_klij, cmtn_klij, cmd_klij)
    if Tests[j] == 'PT1':
        refind = 60
    elif Tests[j] == 'VB2' or Tests[j] == 'VB3' or Tests[j] == 'PP2' or Tests[j] == 'PP3' or Tests[j] == 'SE1':
        refind = 1
    else:
        refind = 2
    ...
    for i in range(len(ex_model)):
        ...
        itcount = 0
        noconv = False
        if Tests[j] == 'PHS1' or Tests[j] == 'PV13' or Tests[j] == 'SL3':
            sig_prev.thr = pi/4 * 44.9/45
        elif Tests[j] == 'SL7':
            sig_prev.thr = pi / 4 * 44.9 / 45
        ...
        while contit_i:
            itcount += 1
            if i < 3:
                sig = stress(sig_prev, 3, MAT, GEOM, cmcc_klij, cmcs_klij, cms_klij, cmtn_klij,cmd_klij)
            else:
                sig = stress(sig_prev, cm_klij, MAT, GEOM, cmcc_klij, cmcs_klij, cms_klij, cmtn_klij,cmd_klij)
        ...
        if noconv:
            ...
            if sig.cm_klij == 4:
                ...
                sdnr[i] = sig.sdnr.real
                tctnr[i] = sig.tctnr.real
                tdtnr[i] = sig.tdtnr.real
                dn[i] = sig.dn.real
                dt[i] = sig.dt.real
        ...
        if isfail == 1:
            ...
            tdtnr = np.delete(tdtnr, range(i, len(wr)), axis=0)
            sdnr = np.delete(sdnr, range(i, len(wr)), axis=0)
    ...
    # Verifications
    eta_fc = [-sc3[i]/fcs[i] for i in range(len(sc3))]
    eta_ssx = [i/fsyx[Tests[j]] for i in ssrx]
    eta_ssy = [i/fsyy[Tests[j]] for i in ssry]
    # ------------------------------------------------------------------------------------------------------------------
    # 3 Plot
    # ------------------------------------------------------------------------------------------------------------------
    ...
    if doplot_main:
        ...
        axs[2, 2].plot(ex_model, model, 'b')
        axs[2, 2].plot(ex_model, submodel, 'k')
        axs[2, 2].legend(['Model', 'Submodel'])
        ...
        axs2[2, 2].plot(ey_model, model, 'b')
        axs2[2, 2].plot(ey_model, submodel, 'k')
        axs2[2, 2].legend(['Model', 'Submodel'])
        ...
        axs4[1, 0].plot(gxy_model, tdtnr, 'm--')
        axs4[1, 0].plot(gxy_model, sdnr, 'r--')
        axs4[1, 0].set_title('Interlock Stresses')
        axs4[1, 0].set(ylabel="Interlock Stresses [MPa]")
        axs4[1, 0].set(xlabel="$\\gamma_{xy,Layer}$ [MPa]")
        axs4[1, 0].legend(['$\sigma_{cnr,tot}$', '$\\tau_{tctnr,tot}$', '$\\tau_{dtnr}$', '$\sigma_{dnr}$'])
    ...
    if target_stress == True:
        str_name = Tests[j] +'_'+ str(cm_klij) + str(cmcc_klij) + str(cmcs_klij) + str(cms_klij) + str(cmtn_klij) \
                   + str(cmd_klij) + str(ff_ev) + str(do_itkin) + str(do_char) + '_'
        ...
        np.savetxt(os.path.join(path, str_name + 'eta_fc.txt'), eta_fc)
        np.savetxt(os.path.join(path, str_name + 'eta_ssx.txt'), eta_ssx)
        np.savetxt(os.path.join(path, str_name + 'eta_ssy.txt'), eta_ssy)
