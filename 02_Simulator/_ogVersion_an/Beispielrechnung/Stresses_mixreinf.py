...
class stress():
    def __init__(self,cm_klij,MAT,GEOM,cmcc_klij = 1,cmcs_klij = 1):
    ...
    def fcs(self):
        ...
        if self.cmcs_klij == 1:
            ...
            # Vecchio & Collins
            fc = min((self.fcp/(0.8+0.34*self.ec0*self.e1)),self.fcp)
        self.fc_soft = fc
        ...
        """ --------------------------------- Calculation concrete compressive stress-----------------------------------
            ...
            - cmcc_klij:     Constitutive Model for Concrete in Compression
                             ...
                             2 = Quadratic stress - strain relation according to
                                 Kaufmann (1998)
                             3 = Quadratic stress - strain relationship according to Sargin
                             4 = Linear elastic stress - strain relationship
            ----------------------------------------------- OUTPUT:-----------------------------------------------------
    ...
    def sigma_cart_32(self):
        ...
        self.sc1 = self.sc(self.e1)
        self.sc3 = self.sc(self.e3)
