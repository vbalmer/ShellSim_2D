...
#         gmsh.model.geo.addPoint(iq*sQT,il*sLT,-H1-H2,2*ms/2)
...
# for j in range(numls):
#     Load_n[j]  = np.array([
#                     [2235,2265,500,500,0,0,3,-(j)*Q/(numls-1)],
#                     [3735,3765,500,500,0,0,3,-(j)*Q/(numls-1)],
...
#         [188]*nl[16],
#         [188]*nl[17]]
# Esx = [205000,145000,145000,145000,145000,145000,145000,145000,145000,145000,145000,145000,145000,153000,153000,153000,153000,153000]
# Eshx = [100,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271,11271]
# fsyx = [520,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5,772.5] # including prestrain of 72.5 MPa (0.5me) with fsy = 700
# fsux = [520*1.08,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5,943.5] # fsu,dyn = 871
# rhoy = [[0.01571]*nl[0],
#         [0.0088]*nl[1],
#         [0.0088]*nl[2],
#         [0.0088]*nl[3],
...
#     for il in range(nLT):
#         gmsh.model.geo.addPoint(iq*sQT,il*sLT,-H1-H2-H3,ms/3)
#         gmsh.model.geo.addPoint(iq*sQT,il*sLT,-H1-H2,ms/2)
#         gmsh.model.geo.addPoint(iq*sQT,il*sLT,-H1,ms)
#         gmsh.model.geo.addPoint(iq*sQT,il*sLT,0,ms)
#
# if nLT == 1:
...
# for j in range(numls):
#     Load_n[j]  = np.array([
#                 [1350,1350,0,0,0,0,3,-(j+1)/numls*Q],
#                 [0,0,0,0,zpl,zpl,1,Pl],
...
# #                 ]))
# BC = np.array(([
#                 [-1,1,-1,1001,0,0,1234,1234,0,1234,1234,1234],
#                 [5999,6001,-1,1001,0,0,0,0,0,0,0,0],
#                 ]))
#
# # 2.2 Loads
# " 2.2 Output:   - Load_el: Global Element Loads "
...
# Q = 90000*B/1000
# Load_el = np.array([
#                 [0,6000,0,1000,0,0,3,-0.00575*0],
#                 [1100,1300,0,1000,0,0,3,-Q/(200*B)],
#                 [3500,3700,0,1000,0,0,3,-Q/(200*B)],
#                  ])
# Load_n  = np.array([
#                 [2235,2265,500,500,0,0,3,0],
#                 # [3500, 3500, 100, 100, 0, 0, 3, -Q / 2]
# ])
#
#
# # -------------------------------------------------------------------------------------------------------------------- #
